...
public class TeacherController  {
    ...
    @GetMapping("/getTeacherByCourseName/{courseName}")
    public ResponseEntity<List<TeacherResponse>> getTeacherByCourseName(@PathVariable String courseName) {
        List<TeacherResponse> teacherResponses = teacherService.getTeacherByCourseName(courseName);
        return ResponseEntity.status(HttpStatus.OK).body(teacherResponses);
    }
